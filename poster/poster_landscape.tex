...
%  background=shade-tb,
  ...
  {}
  % Title
  {\bf{Real Multi-Sense or Pseudo Multi-Sense: An Approach to Improve Word Representation}\vspace{0.5em}}
  % Authors
  {{Haoyue Shi, Caihua Li and Junfeng Hu} ~~~~~~~~~~~ \{hyshi, peterli, hujf\}@pku.edu.cn}
  % University logo
